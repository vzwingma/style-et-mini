 ...
 */
export function selectCriteres(selectedIdCriteres: string[], criteresDisponibles: CapsuleCritereModel[], setSelectedCriteres: React.Dispatch<React.SetStateAction<CapsuleCritereModel[]>>): void {
